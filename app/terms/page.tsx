  ...
  return (
    <main className="policy-shell">
      ...
      <article className="policy-document">
        ...
        <section><h2>安装与使用</h2><p>桌宠只通过官方 Skill 安装，网页不提供 ZIP 直链。用户仍应查看每只桌宠标注的许可证；网站代码、Skill 代码与各个投稿作品的许可证彼此独立。</p></section>
        ...
        <aside><strong>提交反馈</strong><p><a href="https://github.com/javaC2RenXiangjie/codex-pet-club/issues/new" rel="noreferrer" target="_blank">打开 GitHub Issue</a>。许可证选择和专业法律判断应由权利人自行确认；本页是项目运营规则，不构成法律意见。</p></aside>
      </article>
